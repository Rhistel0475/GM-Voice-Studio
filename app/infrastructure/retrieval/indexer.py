...
Usage:
    python -m app.infrastructure.retrieval.indexer --file path/to/rulebook.pdf --doc_type rulebook
    python -m app.infrastructure.retrieval.indexer --dir path/to/docs/ --doc_type session
    python -m app.infrastructure.retrieval.indexer --file notes.txt --doc_type faction
...
from app.core.config import OPENAI_API_KEY, PINECONE_API_KEY, PINECONE_INDEX_NAME
