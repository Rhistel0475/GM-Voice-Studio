...
For typed access use: from app.core.settings import get_settings
"""
import os
...
VOICE_STORAGE_PATH = os.environ.get("VOICE_STORAGE_PATH", str(_ROOT_DIR / "voice_storage"))
...
PENDING_CLONE_PATH = os.environ.get("PENDING_CLONE_PATH", str(_ROOT_DIR / "pending_clones"))
# Dir for async narrate WAV outputs (must be shared with worker if multi-host)
NARRATE_RESULT_PATH = os.environ.get("NARRATE_RESULT_PATH", str(_ROOT_DIR / "narrate_results"))
