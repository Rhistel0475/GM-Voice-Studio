...
- Service: app.services.encounter_service (one-click encounter launch)
- Routes: WebSocket /ws/audio, POST /scene/trigger, POST /scene/activate,
  POST /scene/combat-start, POST /scene/suggestions, POST /encounter/launch
- Depends on: voice domain (TTS, voice list), AI domain (handle_query, generate_dialogue)
"""

__all__ = ["encounter_control", "scene_control", "scene_triggers", "session_control"]
