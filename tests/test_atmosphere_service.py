...
def test_get_atmosphere_audio_returns_static_track(tmp_path, monkeypatch):
    ...
    payload = atmosphere_service.get_atmosphere_audio({"atmosphere_type": "forest"})
...
def test_start_scene_combat_returns_combat_ambience(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        "get_atmosphere_audio",
        lambda scene: {"ambience_track": {"url": "/static/audio/atmosphere/combat.wav", "atmosphere_type": scene.get("atmosphere_override_type")}},
    )
